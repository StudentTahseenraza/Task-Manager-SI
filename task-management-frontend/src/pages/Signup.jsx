...
import { CheckSquare, Mail, Lock, User, Sparkles, Eye, EyeOff } from 'lucide-react';
          ...
          <form className="space-y-5" onSubmit={handleSubmit}>
            ...
            {error && (
              <motion.div
                ...
                animate={{ opacity: 1, y: 0 }}
                className="p-3 rounded-2xl bg-red-50 dark:bg-red-900/20 text-red-600 dark:text-red-400 text-sm text-center"
              >
                {error}
              </motion.div>
            )}
